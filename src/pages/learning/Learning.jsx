...
function Learning() {
  // CommunityPosts နည်းတူ useFetch custom hook အသုံးပြုထားပါသည်
        ...
        {loading ? (
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {journeys.map((j) => (
              ...
              >
                {/* 🚀 1. Top-Left Corner Accent Glow (Hover မှသာ ပေါ်မည်) */}
                <div
                ...
                {/* 🚀 2. Bottom-Right Corner Accent Glow (Hover မှသာ ပေါ်မည်) */}
                <div
